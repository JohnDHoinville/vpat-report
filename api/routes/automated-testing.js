...
router.post('/run/:sessionId', authenticateToken, async (req, res) => {
    try {
        ...
        // Validate tools
        const validTools = ['axe', 'pa11y', 'lighthouse', 'contrast-analyzer', 'mobile-accessibility', 'wave', 'migrated_data', 'playwright', 'playwright-axe', 'playwright-lighthouse', 'cypress', 'selenium', 'webdriver'];
